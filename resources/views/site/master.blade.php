...
<head>
    ...
    <meta name="keywords"
        content="منصة أستاذ أحمد فتحي,أستاذ أحمد فتحي,منصة ماستر رياضيات,رياضيات الثانوية العامة,أستاذ أحمد فتحي ماستر رياضيات ,رياضيات احمد فتحي,رياضيات الصف الثالث الثانوي,جبر الثانوية العامة,تفاضل الثانوية العامة,تكامل الثانوية العامة,تفاضل وتكامل الثانوية العامة,الهندسة الغراغية ثانوية عامة,ديناميكا ثانوية عامة,استاتيكا ثانوية عامة,الرياضات البحتة ثانوية عامة,الرياضات البحتة ثانوية عامة,الرياضات التطبيقية ثانوية عامة">
    <meta name="description"
        content="منصة ماستر الرياضيات التعليمية لتدريس مواد الرياضيات  للثانوية العامة و الازهرية بكافة مراحلها الدراسية مع استاذ احمد فتحي.">
    ...
    <title>الصفحة الرئيسية - أ/ أحمد فتحي</title>
